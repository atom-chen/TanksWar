...
public class GameManager : Manager
{
    ...
    public static string CurMod = "Main";
    /// <summary>
    /// 初始化游戏管理器
    /// </summary>
    void Awake()
    ...
    {
        //Application.persistentDataPath + "/" + game + "/";    ----可读写目录
        string dataPath = Util.DataPath;  //数据目录
        //"jar:file://" + Application.dataPath + "!/assets/"; Application.streamingAssetsPath : ----只读目录
        ...
        Debug.Log("infile path --- " + infile);
        Debug.Log("outfile path --- " + outfile);
    ...
    public static string GetCurMod()
    {
        return CurMod;
    }

    public static void SetCurMod(string modName)
    {
        CurMod = modName;
    }
    ...
    {
        LuaHelper.GetNetManager().OnInit();                     //初始化网络
    }
}
