...
public class UI_UIProgressExWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.UIProgressEx), typeof(UnityEngine.MonoBehaviour));
	...
	static int get_mScorePercent(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UI.UIProgressEx obj = (UI.UIProgressEx)o;
			UI.TextEx ret = obj.mScorePercent;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
