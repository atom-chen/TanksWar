...
public class SequenceHandleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(SequenceHandle), typeof(UnityEngine.MonoBehaviour));
	...
	static int ResetId(IntPtr L)
	{
		try
		{
			...
			SequenceHandle obj = (SequenceHandle)ToLua.CheckObject(L, 1, typeof(SequenceHandle));
			obj.ResetId();
			return 0;
		}
		catch(Exception e)
	...
	static int SyncHandle(IntPtr L)
	{
		try
		{
			...
			Handle arg1 = (Handle)ToLua.CheckObject(L, 3, typeof(Handle));
	...
	static int AddSubHandle(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Component arg0 = (UnityEngine.Component)ToLua.CheckUnityObject(L, 2, typeof(UnityEngine.Component));
			Handle arg1 = (Handle)ToLua.CheckObject(L, 3, typeof(Handle));
			Handle.Type arg2 = (Handle.Type)ToLua.CheckObject(L, 4, typeof(Handle.Type));
	...
	static int RemoveSubHandle(IntPtr L)
	{
		try
		{
			...
			if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(SequenceHandle), typeof(UnityEngine.Component), typeof(Handle), typeof(float)))
			{
				SequenceHandle obj = (SequenceHandle)ToLua.ToObject(L, 1);
				UnityEngine.Component arg0 = (UnityEngine.Component)ToLua.ToObject(L, 2);
				Handle arg1 = (Handle)ToLua.ToObject(L, 3);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 4);
				obj.RemoveSubHandle(arg0, arg1, arg2);
				return 0;
			}
			else if (count == 4 && TypeChecker.CheckTypes(L, 1, typeof(SequenceHandle), typeof(UnityEngine.Component), typeof(Handle), typeof(Handle)))
			{
				SequenceHandle obj = (SequenceHandle)ToLua.ToObject(L, 1);
				UnityEngine.Component arg0 = (UnityEngine.Component)ToLua.ToObject(L, 2);
				Handle arg1 = (Handle)ToLua.ToObject(L, 3);
				Handle arg2 = (Handle)ToLua.ToObject(L, 4);
				obj.RemoveSubHandle(arg0, arg1, arg2);
				return 0;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: SequenceHandle.RemoveSubHandle");
			}
		}
		catch(Exception e)
		{
	...
	static int OffsetTime(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Component arg0 = (UnityEngine.Component)ToLua.CheckUnityObject(L, 2, typeof(UnityEngine.Component));
			Handle arg1 = (Handle)ToLua.CheckObject(L, 3, typeof(Handle));
			System.Collections.Generic.List<Handle> arg2 = (System.Collections.Generic.List<Handle>)ToLua.CheckObject(L, 4, typeof(System.Collections.Generic.List<Handle>));
			float arg3 = (float)LuaDLL.luaL_checknumber(L, 5);
	...
	static int ChangeTime(IntPtr L)
	{
		try
		{
			...
			if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(SequenceHandle), typeof(UnityEngine.Component), typeof(Handle), typeof(float), typeof(float)))
			{
				SequenceHandle obj = (SequenceHandle)ToLua.ToObject(L, 1);
				UnityEngine.Component arg0 = (UnityEngine.Component)ToLua.ToObject(L, 2);
				Handle arg1 = (Handle)ToLua.ToObject(L, 3);
			...
			else if (count == 5 && TypeChecker.CheckTypes(L, 1, typeof(SequenceHandle), typeof(UnityEngine.Component), typeof(Handle), typeof(Handle), typeof(float)))
			{
				SequenceHandle obj = (SequenceHandle)ToLua.ToObject(L, 1);
				UnityEngine.Component arg0 = (UnityEngine.Component)ToLua.ToObject(L, 2);
				Handle arg1 = (Handle)ToLua.ToObject(L, 3);
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: SequenceHandle.ChangeTime");
			}
		}
		catch(Exception e)
		{
	...
	static int GetAllByTime(IntPtr L)
	{
		try
		{
			...
			SequenceHandle obj = (SequenceHandle)ToLua.CheckObject(L, 1, typeof(SequenceHandle));
			float arg0 = (float)LuaDLL.luaL_checknumber(L, 2);
			System.Collections.Generic.List<Handle> o = obj.GetAllByTime(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int GetClosest(IntPtr L)
	{
		try
		{
			...
			Handle o = obj.GetClosest(arg0, arg1, arg2);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int GetRange(IntPtr L)
	{
		try
		{
			...
			System.Collections.Generic.List<Handle> o = obj.GetRange(arg0, arg1);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int GetSubHandle(IntPtr L)
	{
		try
		{
			...
			Handle o = obj.GetSubHandle(arg0);
			ToLua.PushObject(L, o);
			return 1;
		}
		catch(Exception e)
	...
	static int get_m_handles(IntPtr L)
	{
		...
		try
		{
			...
			SequenceHandle obj = (SequenceHandle)o;
			System.Collections.Generic.List<Handle> ret = obj.m_handles;
	...
	static int set_m_handles(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			SequenceHandle obj = (SequenceHandle)o;
			System.Collections.Generic.List<Handle> arg0 = (System.Collections.Generic.List<Handle>)ToLua.CheckObject(L, 2, typeof(System.Collections.Generic.List<Handle>));
			obj.m_handles = arg0;
			return 0;
		}
		catch(Exception e)
