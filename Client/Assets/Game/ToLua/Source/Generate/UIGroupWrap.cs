...
public class UIGroupWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UIGroup), typeof(UnityEngine.MonoBehaviour));
	...
	static int _get_this(IntPtr L)
	{
		try
		{
			...
			UIGroup obj = (UIGroup)ToLua.CheckObject(L, 1, typeof(UIGroup));
