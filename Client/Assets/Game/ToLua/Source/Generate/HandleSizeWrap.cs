...
public class HandleSizeWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(HandleSize), typeof(IHandle));
		...
		L.RegFunction("New", _CreateHandleSize);
	...
	static int _CreateHandleSize(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				HandleSize obj = new HandleSize();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: HandleSize.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnUseNowStart(IntPtr L)
	{
		try
		{
			...
			HandleSize obj = (HandleSize)ToLua.CheckObject(L, 1, typeof(HandleSize));
