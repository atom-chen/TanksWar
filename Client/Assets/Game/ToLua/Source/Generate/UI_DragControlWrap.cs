...
public class UI_DragControlWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.DragControl), typeof(UnityEngine.MonoBehaviour));
	...
	static int AddGlobalHook(IntPtr L)
	{
		try
		{
			...
			UI.DragControl.AddGlobalHook(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int RemoveGlobalHook(IntPtr L)
	{
		try
		{
			...
			UI.DragControl.RemoveGlobalHook(arg0);
			return 0;
		}
		catch(Exception e)
		{
