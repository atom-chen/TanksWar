...
public class HandleColorWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(HandleColor), typeof(IHandle));
		...
		L.RegFunction("New", _CreateHandleColor);
	...
	static int _CreateHandleColor(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				HandleColor obj = new HandleColor();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: HandleColor.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnUseNowStart(IntPtr L)
	{
		try
		{
			...
			HandleColor obj = (HandleColor)ToLua.CheckObject(L, 1, typeof(HandleColor));
