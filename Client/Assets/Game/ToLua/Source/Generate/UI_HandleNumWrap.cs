...
public class UI_HandleNumWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.HandleNum), typeof(UI.IHandle));
		...
		L.RegFunction("New", _CreateUI_HandleNum);
	...
	static int _CreateUI_HandleNum(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UI.HandleNum obj = new UI.HandleNum();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UI.HandleNum.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnUseNowStart(IntPtr L)
	{
		try
		{
			...
			UI.HandleNum obj = (UI.HandleNum)ToLua.CheckObject(L, 1, typeof(UI.HandleNum));
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			UI.HandleNum obj = (UI.HandleNum)o;
