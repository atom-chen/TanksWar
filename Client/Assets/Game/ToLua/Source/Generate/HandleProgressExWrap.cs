...
public class HandleProgressExWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(HandleProgressEx), typeof(IHandle));
		...
		L.RegFunction("New", _CreateHandleProgressEx);
	...
	static int _CreateHandleProgressEx(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				HandleProgressEx obj = new HandleProgressEx();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: HandleProgressEx.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnReset(IntPtr L)
	{
		try
		{
			...
			HandleProgressEx obj = (HandleProgressEx)ToLua.CheckObject(L, 1, typeof(HandleProgressEx));
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			HandleProgressEx obj = (HandleProgressEx)o;
