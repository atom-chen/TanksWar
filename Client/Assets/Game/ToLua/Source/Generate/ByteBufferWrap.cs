...
public class ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("WriteStringEx", WriteStringEx);
		...
		L.RegFunction("ReadStringEx", ReadStringEx);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int WriteStringEx(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadStringEx(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			ByteBuffer obj = (ByteBuffer)ToLua.CheckObject(L, 1, typeof(ByteBuffer));
			string o = obj.ReadStringEx();
			LuaDLL.lua_pushstring(L, o);
			return 1;
		}
		catch(Exception e)
