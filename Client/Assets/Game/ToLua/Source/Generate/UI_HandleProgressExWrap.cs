...
public class UI_HandleProgressExWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.HandleProgressEx), typeof(UI.IHandle));
		...
		L.RegFunction("New", _CreateUI_HandleProgressEx);
	...
	static int _CreateUI_HandleProgressEx(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UI.HandleProgressEx obj = new UI.HandleProgressEx();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UI.HandleProgressEx.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnReset(IntPtr L)
	{
		try
		{
			...
			UI.HandleProgressEx obj = (UI.HandleProgressEx)ToLua.CheckObject(L, 1, typeof(UI.HandleProgressEx));
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			UI.HandleProgressEx obj = (UI.HandleProgressEx)o;
