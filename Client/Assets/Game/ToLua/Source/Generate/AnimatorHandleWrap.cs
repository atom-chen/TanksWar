...
public class AnimatorHandleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(AnimatorHandle), typeof(UnityEngine.MonoBehaviour));
	...
	static int Play(IntPtr L)
	{
		try
		{
			...
			AnimatorHandle obj = (AnimatorHandle)ToLua.CheckObject(L, 1, typeof(AnimatorHandle));
			obj.Play();
			return 0;
		}
		catch(Exception e)
	...
	static int get_m_curAni(IntPtr L)
	{
		...
		try
		{
			...
			AnimatorHandle obj = (AnimatorHandle)o;
