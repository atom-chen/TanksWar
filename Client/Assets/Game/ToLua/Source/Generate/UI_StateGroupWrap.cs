...
public class UI_StateGroupWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.StateGroup), typeof(UnityEngine.MonoBehaviour));
	...
	static int AddGlobalHook(IntPtr L)
	{
		try
		{
			...
			System.Action<UI.StateGroup,int> arg0 = null;
			LuaTypes funcType1 = LuaDLL.lua_type(L, 1);

			if (funcType1 != LuaTypes.LUA_TFUNCTION)
			{
				 arg0 = (System.Action<UI.StateGroup,int>)ToLua.CheckObject(L, 1, typeof(System.Action<UI.StateGroup,int>));
			}
			else
			{
				LuaFunction func = ToLua.ToLuaFunction(L, 1);
				arg0 = DelegateFactory.CreateDelegate(typeof(System.Action<UI.StateGroup,int>), func) as System.Action<UI.StateGroup,int>;
			}

			UI.StateGroup.AddGlobalHook(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int RemoveGlobalHook(IntPtr L)
	{
		try
		{
			...
			UI.StateGroup.RemoveGlobalHook(arg0);
			return 0;
		}
		catch(Exception e)
		{
	...
	static int get_m_itemTemplate(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UI.StateGroup obj = (UI.StateGroup)o;
			UI.StateHandle ret = obj.m_itemTemplate;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_m_ctrlType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UI.StateGroup obj = (UI.StateGroup)o;
			UI.StateGroup.CtrlType ret = obj.m_ctrlType;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
