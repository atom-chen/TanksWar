...
public class DragListenerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(DragListener), typeof(UnityEngine.MonoBehaviour));
	...
	static int OnInitializePotentialDrag(IntPtr L)
	{
		try
		{
			...
			DragListener obj = (DragListener)ToLua.CheckObject(L, 1, typeof(DragListener));
	...
	static int get_onDragBegin(IntPtr L)
	{
		...
		try
		{
			...
			DragListener obj = (DragListener)o;
