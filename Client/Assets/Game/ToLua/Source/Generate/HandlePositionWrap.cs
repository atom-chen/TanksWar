...
public class HandlePositionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(HandlePosition), typeof(IHandle));
		...
		L.RegFunction("New", _CreateHandlePosition);
	...
	static int _CreateHandlePosition(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				HandlePosition obj = new HandlePosition();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: HandlePosition.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnUseNowStart(IntPtr L)
	{
		try
		{
			...
			HandlePosition obj = (HandlePosition)ToLua.CheckObject(L, 1, typeof(HandlePosition));
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			HandlePosition obj = (HandlePosition)o;
