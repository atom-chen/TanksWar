...
public class UIArtFontWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UIArtFont), typeof(UnityEngine.MonoBehaviour));
	...
	static int SetNum(IntPtr L)
	{
		try
		{
			...
			UIArtFont obj = (UIArtFont)ToLua.CheckObject(L, 1, typeof(UIArtFont));
	...
	static int get_s_alignLeft(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UIArtFont.s_alignLeft);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_s_alignMiddle(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UIArtFont.s_alignMiddle);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_s_alignRight(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UIArtFont.s_alignRight);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_s_archer(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UIArtFont.s_archer);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_m_align(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIArtFont obj = (UIArtFont)o;
			UIArtFont.enAlign ret = obj.m_align;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_m_align(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UIArtFont obj = (UIArtFont)o;
			UIArtFont.enAlign arg0 = (UIArtFont.enAlign)ToLua.CheckObject(L, 2, typeof(UIArtFont.enAlign));
			obj.m_align = arg0;
			return 0;
		}
		catch(Exception e)
