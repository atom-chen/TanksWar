...
public class UIScrollTipsWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UIScrollTips), typeof(UnityEngine.MonoBehaviour));
	...
	static int ScrollPos(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.UI.ScrollRect), typeof(UnityEngine.RectTransform)))
			{
				...
				UIScrollTips.ScrollPos(arg0, arg1);
				return 0;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UIScrollTips.ScrollPos");
			}
		}
		catch(Exception e)
		{
	...
	static int get_leftOrTop(IntPtr L)
	{
		...
		try
		{
			...
			UIScrollTips obj = (UIScrollTips)o;
