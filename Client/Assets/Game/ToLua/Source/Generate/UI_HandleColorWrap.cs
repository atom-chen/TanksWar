...
public class UI_HandleColorWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.HandleColor), typeof(UI.IHandle));
		...
		L.RegFunction("New", _CreateUI_HandleColor);
	...
	static int _CreateUI_HandleColor(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UI.HandleColor obj = new UI.HandleColor();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UI.HandleColor.New");
			}
		}
		catch(Exception e)
		{
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			UI.HandleColor obj = (UI.HandleColor)o;
