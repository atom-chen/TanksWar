...
public class UI_HandleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.Handle), typeof(System.Object));
		...
		L.RegFunction("New", _CreateUI_Handle);
	...
	static int get_TypeName(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UI.Handle.TypeName);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_PlayTypeName(IntPtr L)
	{
		try
		{
			ToLua.Push(L, UI.Handle.PlayTypeName);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_CurType(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UI.Handle obj = (UI.Handle)o;
			UI.Handle.Type ret = obj.CurType;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
