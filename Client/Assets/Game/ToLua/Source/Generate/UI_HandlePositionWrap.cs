...
public class UI_HandlePositionWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.HandlePosition), typeof(UI.IHandle));
		...
		L.RegFunction("New", _CreateUI_HandlePosition);
	...
	static int _CreateUI_HandlePosition(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UI.HandlePosition obj = new UI.HandlePosition();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UI.HandlePosition.New");
			}
		}
		catch(Exception e)
		{
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			UI.HandlePosition obj = (UI.HandlePosition)o;
