...
public class UI_HandleScaleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(UI.HandleScale), typeof(UI.IHandle));
		...
		L.RegFunction("New", _CreateUI_HandleScale);
	...
	static int _CreateUI_HandleScale(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				UI.HandleScale obj = new UI.HandleScale();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: UI.HandleScale.New");
			}
		}
		catch(Exception e)
		{
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			UI.HandleScale obj = (UI.HandleScale)o;
