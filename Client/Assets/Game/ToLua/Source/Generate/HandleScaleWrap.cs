...
public class HandleScaleWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(HandleScale), typeof(IHandle));
		...
		L.RegFunction("New", _CreateHandleScale);
	...
	static int _CreateHandleScale(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				HandleScale obj = new HandleScale();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: HandleScale.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnUseNowStart(IntPtr L)
	{
		try
		{
			...
			HandleScale obj = (HandleScale)ToLua.CheckObject(L, 1, typeof(HandleScale));
