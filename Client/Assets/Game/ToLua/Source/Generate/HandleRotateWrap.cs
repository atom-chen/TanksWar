...
public class HandleRotateWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(HandleRotate), typeof(IHandle));
		...
		L.RegFunction("New", _CreateHandleRotate);
	...
	static int _CreateHandleRotate(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				HandleRotate obj = new HandleRotate();
				ToLua.PushObject(L, obj);
				return 1;
			}
			else
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: HandleRotate.New");
			}
		}
		catch(Exception e)
		{
	...
	static int OnUseNowStart(IntPtr L)
	{
		try
		{
			...
			HandleRotate obj = (HandleRotate)ToLua.CheckObject(L, 1, typeof(HandleRotate));
	...
	static int get_IsDurationValid(IntPtr L)
	{
		...
		try
		{
			...
			HandleRotate obj = (HandleRotate)o;
